            ...
            children: <Widget>[
              if (_currentFooter != null)
                Container(
                    ...
                    width: 1000,
                    child:
                        ModalBarrier(color: Colors.black26.withOpacity(.50))),
              _buildBar(),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: BottomAreaAvoider(
          ...
          autoScroll: false,
          child: widget
              .child), // Todo Turned autoScroll off to fix sliver scroll problem
    );
  }
}
